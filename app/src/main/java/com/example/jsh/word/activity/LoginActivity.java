    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOAuthLoginButton.setOAuthLoginHandler(new OAuthLoginHandler() {
            ...
            public void run(boolean success) {
                final boolean msuccess = success;
                new Thread() {
                    public void run() {
                        if (msuccess) {
                            mSessionUtil.setAccessToken(mOAuthLoginModule.getAccessToken(mContext));
                            String response = mCommonUtil.getId(mSessionUtil.getAccessToken());
                            mSessionUtil.setProfileJson(response);
                            mSessionUtil.setInfoFromProfile(response);
